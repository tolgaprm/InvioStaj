...
object TestConstants {
    ...
    val responseListOfMovies2 = listOf(
        oppenheimerMovie.copy(id = 1),
        godFatherMovie.copy(id = 2)
    )
    ...
    const val movieDetailId = 872585

    const val oppenheimerQuery = "oppenheimer"
